(function (global, factory) {
  typeof exports === "object" && typeof module !== "undefined"
    ...
    : ((global =
      ...
      (global.THREE.CSM = factory(global.THREE))));
})(this, function (three) {
  "use strict";
...
uniform float shadowFar;
  ...
  class CSMHelper extends three.Group {
    ...
    update() {
      ...
      const frustumLines = this.frustumLines;
      const frustumLinePositions =
        frustumLines.geometry.getAttribute("position");
      const cascadeLines = this.cascadeLines;
      const cascadePlanes = this.cascadePlanes;
      const shadowLines = this.shadowLines;
      ...
      while (cascadeLines.length < cascades) {
        const cascadeLine = new three.Box3Helper(
          new three.Box3(),
        ...
        const cascadePlane = new three.Mesh(
          new three.PlaneGeometry(),
          planeMat
        );
        const shadowLineGroup = new three.Group();
        const shadowLine = new three.Box3Helper(
          new three.Box3(),
  ...
  class CSM {
    constructor(data) {
      ...
      this.maxCascades =
        (_b = data.maxCascades) !== null && _b !== void 0 ? _b : data.cascades;
      this.maxFar = (_c = data.maxFar) !== null && _c !== void 0 ? _c : 100000;
      this.mode = (_d = data.mode) !== null && _d !== void 0 ? _d : "practical";
      this.practicalModeLambda =
        (_e = data.practicalModeLambda) !== null && _e !== void 0 ? _e : 0.5;
      this.shadowMapSize =
        (_f = data.shadowMapSize) !== null && _f !== void 0 ? _f : 2048;
      this.shadowBias =
        (_g = data.shadowBias) !== null && _g !== void 0 ? _g : 0;
      this.shadowNormalBias =
        (_h = data.shadowNormalBias) !== null && _h !== void 0 ? _h : 0;
      this.lightDirection =
        (_j = data.lightDirection) !== null && _j !== void 0
          ? _j
          : new three.Vector3(1, -1, 1).normalize();
      this.lightDirectionUp =
        (_k = data.lightDirectionUp) !== null && _k !== void 0
          ? _k
          : three.Object3D.DEFAULT_UP;
      this.lightIntensity =
        (_l = data.lightIntensity) !== null && _l !== void 0 ? _l : 1;
      this.lightColor =
        (_m = data.lightColor) !== null && _m !== void 0
          ? _m
          : new three.Color(0xffffff);
      this.lightMargin =
        (_o = data.lightMargin) !== null && _o !== void 0 ? _o : 200;
      this.fade = (_p = data.fade) !== null && _p !== void 0 ? _p : false;
      this.noLastCascadeCutOff =
        (_q = data.noLastCascadeCutOff) !== null && _q !== void 0 ? _q : false;
    ...
    updateBreaks() {
      ...
      switch (this.mode) {
        ...
        case "custom":
          ...
          this.breaks.push(
            ...this.customSplitsCallback(this.cascades, camera.near, far)
          );
          break;
      }
    }
    ...
    setupMaterial(material) {
      const fn = (shader) => {
        ...
        shader.uniforms.cameraNear = {
          value: Math.min(this.maxFar, this.camera.near),
        };
